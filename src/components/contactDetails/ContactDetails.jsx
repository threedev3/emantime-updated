    ...
    <div className="bg-missionbg relative max-w-full">
      <div className="sm:pt-5">
        <div className="relative isolate overflow-hidden px-6 py-8 lg:pt-0 lg:py-8 shadow-2xl md:pt-8 flex flex-col gap-6">
          <div className="mx-auto flex flex-col justify-center items-start gap-10 md:flex md:flex-row md:items-center md:justify-between md:gap-x-10 sm:flex sm:flex-col sm:justify-center lg:max-w-7xl">
                  ...
                  <ul className="flex flex-col gap-4">
                    <li className="flex items-center gap-3">
                      <div>
                        <svg
                          aria-hidden="true"
                          className="h-6 fill-green-700 e-font-icon-svg e-fab-whatsapp"
                          viewBox="0 0 448 512"
                    ...
                    <li className="flex items-center gap-3">
                      <div>
                        <svg
                          aria-hidden="true"
                          className="h-6 fill-green-700 e-font-icon-svg e-fas-phone-alt"
                          viewBox="0 0 512 512"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                    ...
                    <li className="flex items-center gap-3">
                      <div>
                        <svg
                          aria-hidden="true"
                          className="h-6 fill-green-700 e-font-icon-svg e-fas-map-marker-alt"
                          viewBox="0 0 384 512"
                          xmlns="http://www.w3.org/2000/svg"
                        >
